...
export default function Advice({counter , setQuote, advice, id}){
    ...
    return(
        <>
            <section className="grid bg-gray-800 max-w-md min-h-fit border-0 rounded-2xl p-8 mx-auto my-8 relative ">
                ...
                <button 
                className=" md:hover:animate-spin border border-green-400 bg-green-400 p-4 my-2 w-14 h-14 rounded-full absolute bottom-[-2.25rem] left-[43.8%]" onClick={getQuote}>
